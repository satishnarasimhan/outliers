 # -*- coding: utf-8 -*-
"""
This code is used to automatically download the DAY wise data (Bhavcopy.zip from NSE Website ) from 2016 onwards as a csv file.
Parameters:
...
End_date="12OCT2019"
File to be downloaded = Bhavcopy(zip) in NSE
Name of file downloaded = fo.zip
url = 'https://www1.nseindia.com/content/fo/fo.zip'
Files to be downloaded will be named fo<ddmmyy>.csv and op<ddmmyy>.csv
"""
...
for single_date in daterange:
    ...
    if weekday not in [5,6]:
        ...
        ## For Archive Files
        ##temp_zip_file_url = 'https://www1.nseindia.com/products/content/derivatives/equities/archieve_fo/fo'+ddmmyy+'zip'
        ## temp_zip_file_url = 'https://www1.nseindia.com/content/historical/EQUITIES/'+year+'/'+month+'/cm'+date+month+year+'bhav.csv.zip'
        ##temp_zip_file_url = 'https://nseindia.com/content/historical/DERIVATIVES/'+year+'/'+month+'/fo'+date+month+year+'bhav.csv.zip'
